...
<div id="content" class="site-content">  	
    ...
    <div id="primary" class="content-area <?php gympress_layout_class(); ?>  columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
			...
			<?php do_action('gympress_after_single_content'); ?>
			<?php if( get_theme_mod ('social_sharing_box')): ?>
				<div class="share-box">
					<h4><?php _e( 'Share this on ...', 'gympress' ); ?></h4>
					<ul>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'gympress_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php gympress_related_posts(); ?>
				</section>
			<?php endif;  ?>
